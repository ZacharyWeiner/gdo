...
export function useFetchOrders(){
    ...
    const getOrderPrice = async(location, time, useOrigin, jigName) => {
    ...
    const getOpenOrders = async() => {
        ...
        await exchrate();
        await getOrderPrice('1ba1080086ca6624851e1fbff18d903047f2b75d3a9ffe5cc8bf49ed0fdb36a0_o2', prevTime(time), false, 'Gopnik');
