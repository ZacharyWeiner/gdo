<template>
    <div class=" w-full min-w-xl mx-auto">
        <div class="w-full justify-center">
           ...
           <div class="h-full rounded-xl ring-2 ring-gray-300 ">
               <div class="overflow-y-scroll  max-h-96 p-2 m-2">
                   <Message
...
export default {
    ...
    computed: {
        ...
        filteredMessages (){
            ...
            else {_messages = this.messages.filter(m => (!m.propId || m.propId < 1 || m.propId == 'Public'))}
            console.log(_messages[0])
            return _messages.sort((a, b) => a.createdAt.seconds < b.createdAt.seconds)
        },
